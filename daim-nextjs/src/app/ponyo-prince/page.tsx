  ...
  return (
    <div className="font-sans min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <section className="section-luxury py-24">
        <div className="container mx-auto px-4">
          <div className="section-header text-center mb-16">
            <h2 className="section-title text-4xl md:text-5xl font-light mb-6">SONG SETTINGS</h2>
            <p className="text-xl text-gray-300">DAIM Driver</p>
          </div>
          
          <div className="max-w-4xl mx-auto">
            <div className="card-intelligent p-8 bg-white/5 rounded-xl border border-white/10">
              <p className="card-description text-gray-300 leading-relaxed mb-4">
                コスプレイヤー、DJ、グラビア等の、様々な活動をしているぽにょ皇子。DJにおいては、アニソンDJとして活躍。
              </p>
              <p className="card-description text-gray-300 leading-relaxed mb-4">
                そこで、生成する楽曲をアニソンの主題歌らしいイメージで検討。プロジェクト第一弾としてA.I.による楽曲自動生成から、「A.I.(＝Android Imagination)」として彼女の記憶をたどる世界観で設定。
              </p>
              <p className="card-description text-gray-300 leading-relaxed mb-4">
                世界観をヴィジュアル化する上で、近い未来、大国による争いが世界に広まってしまったら・・・奪い合う大国と音楽で時間や空間を多くの人と共有し、その記憶が眠る戦いたくないアンドロイド化した者との戦い・・・
              </p>
              <p className="card-description text-gray-300 leading-relaxed mb-4">
                そんな架空のバトルアニメの主題歌。戦いを止める鍵は、AIなのか、Humanなのか、それとも歌なのか・・・
              </p>
              <p className="card-description text-gray-300 leading-relaxed">
                ぽにょ皇子2nd.シングル「変幻自在」の変幻性をコスプレから更に拡張し、バトルアニメ内で争いを止めるキャラクターとして設定。傷つきながらもヒューマノイドとして戦う姿を歌詞にした。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-luxury py-24 bg-black/30">
        <div className="container mx-auto px-4">
          <div className="section-header text-center mb-16">
            <h2 className="section-title text-4xl md:text-5xl font-light mb-6">LYRICS</h2>
            <div className="text-center mb-8">
              <h3 className="text-2xl font-light text-slate-300 mb-2">A.I.（Android Imagination）</h3>
              <p className="text-gray-400">Writing：DAIM Driver Shiro Koba</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl">
              <div className="lyrics-content space-y-6 text-gray-300 leading-relaxed">
                <div className="verse">
                  <p>サイリウムが眩しい</p>
                  <p>固いベッドの上</p>
                  <p>戦いぬいていた記憶</p>
                ...
                <div className="chorus bg-gradient-to-r from-slate-600/20 to-blue-700/20 rounded-lg p-6 border border-slate-500/20">
                  <p className="font-medium text-slate-200">ヒューマノイドの夢は現実なの？</p>
                  <p className="font-medium text-slate-200">感覚がないはずなのに湧き出る感情</p>
                  <p className="font-medium text-slate-200">イマジネーションは誰のもの？</p>
                  <p className="font-medium text-slate-200">色あふれる世界へ、さあ戻ろう</p>
                </div>
                
                <div className="hook text-center text-lg font-medium text-blue-300">
                  <p>AI、色奪（Irodori）、AI、色奪（Irodori）、AI、色奪（Irodori）、AI、色奪（Irodori）</p>
                </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-gradient-to-r from-slate-600/20 to-blue-700/20 rounded-lg p-6 border border-slate-500/20">
                  ...
                  >
                    ...
                    <source src="/audio/AI-trance-rap-2.wav" type="audio/*" />
      ...
      <section className="section-luxury py-24">
        <div className="container mx-auto px-4">
          <div className="section-header text-center mb-16">
            <h2 className="section-title text-4xl md:text-5xl font-light mb-6">A.I. MOVIE</h2>
            <p className="text-xl text-gray-300">AIによる生成映像にもチャレンジ</p>
          </div>
          
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl text-center">
              <div className="text-6xl mb-6">🎬</div>
              <h3 className="text-2xl font-light mb-4">AI生成映像動画</h3>
              <p className="text-gray-300 mb-6">
                ぽにょ皇子による楽曲プロデュース制作作業と同時に、AIによる生成映像動画も織り交ぜながらミュージックビデオも制作し完成させます。
              </p>
              <div className="bg-gradient-to-r from-slate-600/20 to-blue-700/20 rounded-lg p-6 border border-slate-500/20">
      ...
      <section className="section-luxury py-24 bg-black/30">
        <div className="container mx-auto px-4">
          <div className="section-header text-center mb-16">
            <h2 className="section-title text-4xl md:text-5xl font-light mb-6">A.I. MV COSTUME</h2>
            <p className="text-xl text-gray-300">ミュージックビデオの衣装をみんなで決める</p>
          </div>
          
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="card-intelligent p-6 bg-white/5 rounded-xl border border-white/10 text-center hover:bg-white/10 transition-all duration-300 group">
                ...
                <h3 className="text-lg font-light mb-2 text-slate-200">DJぽにょ皇子が</h3>
                <p className="text-gray-400 text-sm">アンドロイドに</p>
              </div>
              ...
              <div className="card-intelligent p-6 bg-white/5 rounded-xl border border-white/10 text-center hover:bg-white/10 transition-all duration-300 group">
                ...
                <h3 className="text-lg font-light mb-2 text-slate-200">近未来の</h3>
                <p className="text-gray-400 text-sm">ぽにょ皇子か</p>
              </div>
              ...
              <div className="card-intelligent p-6 bg-white/5 rounded-xl border border-white/10 text-center hover:bg-white/10 transition-all duration-300 group">
                ...
                <h3 className="text-lg font-light mb-2 text-slate-200">猫耳ドロイド</h3>
                <p className="text-gray-400 text-sm">ぽにょ皇子</p>
              </div>
              ...
              <div className="card-intelligent p-6 bg-white/5 rounded-xl border border-white/10 text-center hover:bg-white/10 transition-all duration-300 group">
                ...
                <h3 className="text-lg font-light mb-2 text-slate-200">魔法使いが</h3>
                <p className="text-gray-400 text-sm">戦いを止める</p>
              </div>
            </div>
            
            <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl text-center">
              <div className="text-6xl mb-6">👗</div>
              <h3 className="text-2xl font-light mb-4">A.I. コスチューム投票</h3>
              <p className="text-gray-300 mb-6">
                ミュージックビデオの衣装をみんなで決める投票を実施予定です。
              </p>
              <div className="bg-gradient-to-r from-slate-600/20 to-blue-700/20 rounded-lg p-6 border border-slate-500/20">
                <p className="text-sm text-slate-300">
                  投票はこちら
