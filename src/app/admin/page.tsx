...
export default function AdminPage() {
  console.log('🟢 ADMIN PAGE LOADED - FINAL VERSION 11:35');
  ...
  const fetchVotes = async () => {
    ...
    try {
      const keyToUse = adminKey || 'DAIM_TEST_ADMIN_KEY_2024';
      ...
      if (response.ok) {
        ...
        console.log('🔴 STATE SET WITH', (data.votes || []).length, 'votes');
      } else {
      ...
      console.log('🔴 FETCH VOTES COMPLETED');
    }
  };
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-white/10">
                          {filteredVotes && filteredVotes.length > 0 ? filteredVotes.map((vote, index) => (
