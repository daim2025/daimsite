...
const translations = {
  ja: {
    ...
    'ponyopage.videos.intro': '◎Explanatory Video',
    'ponyopage.videos.song': '◎The first music and video generated by AI',
    'ponyopage.videos.intro.url': 'https://player.vimeo.com/video/1117628867?h=0&autoplay=0&title=0&byline=0&portrait=0',
    'ponyopage.videos.song.url': 'https://player.vimeo.com/video/1117630593?h=0&autoplay=0&title=0&byline=0&portrait=0',
